...
def draw_brush_on_image(brush: Brush, image: np.ndarray) -> np.ndarray:
    ...
    foreground_subsection = foreground[y_min - draw_y : y_max - draw_y, x_min - draw_x : x_max - draw_x]
    alpha_subsection = alpha_3[y_min - draw_y : y_max - draw_y, x_min - draw_x : x_max - draw_x]
